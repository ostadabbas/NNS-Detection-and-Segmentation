...
image_folder = os.path.join('./data', args.fold, 'video_data')
abs_path = os.path.dirname(os.path.abspath(image_folder))
if not os.path.exists(os.path.join(abs_path, 'annotation')):
    os.mkdir(os.path.join(abs_path, 'annotation'))
...
shutil.move(r'./data/' + args.fold + '/classInd.txt', r'./data/' + args.fold + '/annotation/')
# os.system("mv ./data/testlist01.txt ./data/annotation/")
shutil.move(r'./data/' + args.fold + '/testlist01.txt', r'./data/' + args.fold + '/annotation/')
# os.system("mv ./data/trainlist01.txt ./data/annotation/")
shutil.move(r'./data/' + args.fold + '/trainlist01.txt', r'./data/' + args.fold + '/annotation/')
